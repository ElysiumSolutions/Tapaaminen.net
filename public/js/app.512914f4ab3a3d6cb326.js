...
function fillTimesTable() {
    ...
    for (var k = 0; k < parts.length; k++) {
        ...
        if (date !== "") {
            ...
            timerow = timerow + '' + '<td class="has-text-right"><button class="button is-danger is-small is-outlined" type="button" onclick="removeTimeRow(\'' + date + '\')"><span class="icon is-small"><i class="fa fa-times-circle"></i></span></button></td>' + '</tr>';
